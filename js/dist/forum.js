      ...
      node.addEventListener('load', function () {
        if (node.height > maxHeight) {
          if (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('huoxin-auto-collapse-long-images.use-flarumite-simple-spoilers') == 1) {
            var customText = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('huoxin-auto-collapse-long-images.flarumite-simple-spoilers-custom-text');
            var spoilerMarkup = isFancybox(node) ? generateFlarumiteSpoiler(node.parentNode.outerHTML, customText) : generateFlarumiteSpoiler(node.outerHTML, customText);
...
function generateFlarumiteSpoiler(imageHtml, customText) {
  return "\n    <details class=\"flarumite-spoiler\">\n      <summary>\n        <span class=\"flarumite-spoiler--title flarumite-spoiler--title-closed\">\n          <span class=\"flarumite-spoiler--custom-text\">" + customText + "</span>\n          <span class=\"flarumite-spoiler--default-text\">" + flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('huoxin-auto-collapse-long-images.forum.default-text.closed') + "</span>\n        </span>\n        <span class=\"flarumite-spoiler--title flarumite-spoiler--title-open\">\n          <span class=\"flarumite-spoiler--custom-text\">" + customText + "</span>\n          <span class=\"flarumite-spoiler--default-text\">" + flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('huoxin-auto-collapse-long-images.forum.default-text.open') + "</span>\n        </span>\n      </summary>\n      <div class=\"flarumite-spoiler--content\">\n        <p>" + imageHtml + "</p>\n      </div>\n    </details>";
}
